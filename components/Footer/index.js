        ...
        <div className="relative flex flex-row items-center justify-between">
          <div className="left flex flex-row">
            <h1 className=" text-[15px] ">
              <span className="font-extrabold">Neshab Ansari</span>
            </h1>
  ...
  return (
    <div className="w-screen flex flex-row items-center justify-center absolute bottom-[100px] mx-auto md:bottom-[10px]">
      <span className="py-2 text-[12px] text-white-200 ">
        Powered with 💖 by <a target="_blank" href="https://github.com/Neshabansari" className="text-green-200 underline hover:text-green-200">Neshab Ansari</a>
      </span>
    </div>
  )
}